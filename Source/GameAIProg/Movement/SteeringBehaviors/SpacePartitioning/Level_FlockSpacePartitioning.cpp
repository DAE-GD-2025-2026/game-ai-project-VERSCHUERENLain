...
#include "Level_FlockSpacePartitioning.h"
#include "imgui.h"
#include "Shared/ImGuiHelpers.h"


ALevel_FlockSpacePartitioning::ALevel_FlockSpacePartitioning()
{
	PrimaryActorTick.bCanEverTick = true;
}

void ALevel_FlockSpacePartitioning::BeginPlay()
{
	Super::BeginPlay();
	RebuildFlock();
}
...
void ALevel_FlockSpacePartitioning::Tick(float DeltaTime)
{
